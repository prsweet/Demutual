    ...
    <div className="p-2 w-screen min-h-screen bg-transparent font-sans">
      ...
      <div className="absolute top-[calc(100vh-10rem)] left-0 right-0 z-50 flex flex-col items-center pointer-events-none">
        ...
        <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 px-4 pointer-events-auto">
          <img src="https://res-console.cloudinary.com/dbvotc5ja/thumbnails/v1/image/upload/v1778536243/dmVjdGVlenlfc29sYW5hLWxvZ28tb24tdHJhbnNwYXJlbnQtYmFja2dyb3VuZF8tcmVtb3ZlYmctcHJldmlld19paXNidG8=/drilldown" alt="Solana" className="h-10 md:h-16 object-contain brightness-0 invert opacity-80 hover:opacity-100 transition-opacity cursor-pointer" />
          <img src="https://res-console.cloudinary.com/dbvotc5ja/thumbnails/v1/image/upload/v1778536238/YzNhZDczMGJhODg5NTdmZTg0YTEyY2M1MzE5NjUyYzZmOTk1YmRiMl8yXzY5MHgzNDUtcmVtb3ZlYmctcHJldmlld19td3BuZW0=/drilldown" alt="Partner Logo" className="h-10 md:h-16 object-contain brightness-0 invert opacity-80 hover:opacity-100 transition-opacity cursor-pointer" />
